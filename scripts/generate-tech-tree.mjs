...
const RESEARCH_NAME_JA = {
  "Armored Artillery Compartment": "装甲砲兵区画",
  "Armored Artillery Decks": "装甲砲兵デッキ",
  "Armored Balconies": "装甲バルコニー",
  "Armored Deck": "装甲デッキ",
  "Armored Vestibule": "装甲前室",
  "Armor": "アーマー",
  "Armor III": "アーマー III",
  "Armor Plate II": "アーマープレート II",
  "Armor Plate III": "アーマープレート III",
  "Artillery Decks": "砲兵デッキ",
  "Autocannon": "オートキャノン",
  "Autocannon II": "オートキャノン II",
  "Autocannon III": "オートキャノン III",
  "Autocannon IV": "オートキャノン IV",
  "Balconies": "バルコニー",
  "Battering Ram": "破城槌",
  "Cannon": "キャノン",
  "Cannon III": "キャノン III",
  ...
  "Captain's Cabin": "船長室",
  "Cargo Bay": "貨物ベイ",
  "Cargo Bay IV": "貨物ベイ IV",
  "Cargo Deck": "貨物デッキ",
  "Cargo Hold": "貨物室",
  "Cargo Hold III": "貨物室 III",
  "Crafting Materials": "クラフト素材",
  "Crew Room": "クルールーム",
  "Crew Room II": "クルールーム II",
  "Embrasure": "銃眼",
  "Enclosed Artillery Compartment": "密閉砲兵区画",
  "Energy Rod": "エネルギーロッド",
  "Framed Armored Artillery Deck": "フレーム装甲砲兵デッキ",
  "Framed Artillery Deck": "フレーム砲兵デッキ",
  "Framed Stairs": "フレーム階段",
  "Framed Steering": "フレーム操舵室",
  "Great Chassis": "大型シャーシ",
  "Grenade III": "グレネード III",
  "Improved Ammo": "改良弾薬",
  "Large Armament Workshop": "大型兵装工房",
  "Large Framed Steering": "大型フレーム操舵室",
  "Large Open Steering": "大型オープン操舵室",
  "MedKit": "メディキット",
  "Medium Engine": "中型エンジン",
  "Metal Corridor": "金属通路",
  "Middling Chassis": "中型シャーシ",
  "Middling Chassis (832U)": "中型シャーシ（832U）",
  "Motor-Reactor": "モーターリアクター",
  "Motor-Reactor II": "モーターリアクター II",
  "Motor-Reactor III": "モーターリアクター III",
  "Resources": "資源",
  "Royal Chassis": "ロイヤルシャーシ",
  "Shotgun Cannon": "ショットガン砲",
  "Shotgun Cannon II": "ショットガン砲 II",
  "Shotgun Cannon III": "ショットガン砲 III",
  "Shotgun Cannon IV": "ショットガン砲 IV",
  "Shovel": "シャベル",
  "Small Armament Workshop": "小型兵装工房",
  "Small Chassis": "小型シャーシ",
  "Small Engine II": "小型エンジン II",
  "Smoke Grenade": "スモークグレネード",
  "Smokeless Rod": "スモークレスロッド",
  "Stairs": "階段",
  "Steering II": "操舵室 II",
  "Steering III": "操舵室 III",
  "Time Bomb": "時限爆弾",
  "Weapons": "武器",
  "Weapons II": "武器 II",
  "Weapons IV": "武器 IV",
  "Wooden Corridor": "木製通路",
  "Wooden Decks": "木製デッキ",
  "Wooden Vestibule": "木製前室",
};

function japaneseResearchName(name) {
  return RESEARCH_NAME_JA[name] ?? "";
}
...
function buildNodesFromResearchTree(researchTree, progressionDescriptions) {
  ...
  const nodes = [...researchTree.nodesById.values()].map((treeNode, nodeIndex) => {
    ...
    return {
      ...
      displayNameJa: japaneseResearchName(description?.name ?? treeNode.id),
      branch: branchName,
...
async function main() {
  ...
  if (researchTree) {
    ...
    const sourceInfo = {
      sourceUrl: "local ResearchTreeJsonDto JSON",
      generatedAt,
      displayNameJaSource: "local research name dictionary",
        ...
        $(tierRow)
          ...
          .each((nodeIndex, node) => {
            ...
            nodes.push({
              ...
              name,
              displayNameJa: japaneseResearchName(name),
              branch: branchName,
              branchSlug: branchMeta.slug,
